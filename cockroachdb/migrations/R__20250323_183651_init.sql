...
-- Пользователь Телеграма (комментатор)
CREATE TABLE IF NOT EXISTS tg_user (
    user_id INT PRIMARY KEY,
    username STRING(256) NOT NULL,
    first_name STRING(256), -- NULL, если нет имени
    last_name STRING(256), -- NULL, если нет фамилии
    photo_file_id STRING(256) -- NULL, если нет фото
);
